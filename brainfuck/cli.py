...
def parse_args():
    ...
    parser.add_argument("file", help="brainfuck program file (or code with -c) to run")
    parser.add_argument(
        "-t", action="store_true", help="output execution time after running"
    )
    parser.add_argument(
        "-n", action="store_true", help="append a newline to the programs output"
    )
    parser.add_argument("-c", action="store_true", help="brainfuck code string to run")
    parser.add_argument(
        "-o",
        action="store_true",
